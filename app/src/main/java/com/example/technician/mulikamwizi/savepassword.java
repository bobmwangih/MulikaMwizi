...
public class savepassword extends Activity {
   ...
   CheckBox sjsu,sjsu2,sdsu,sdsu2,lb,lb2,csula,csula2,santa,santa2,sfu,sfu2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sjsu = findViewById(R.id.sjsu);
        sdsu = findViewById(R.id.sdsu);
        sjsu2 = findViewById(R.id.sjsu2);
        sdsu2 = findViewById(R.id.sdsu2);
        lb = findViewById(R.id.lb);
        lb2 = findViewById(R.id.lb2);
        csula = findViewById(R.id.csula);
        csula2 = findViewById(R.id.csula2);
        sfu = findViewById(R.id.sfu);
        sfu2 = findViewById(R.id.sfu2);
        santa = findViewById(R.id.santa);
        santa2 = findViewById(R.id.santa2);
